...
<div class="max-w-4xl mx-auto" x-data="{ 
    ...
    init() {
        ...
        this.$watch('stock', () => this.generateCode());
    },
    generateCode() {
        if (this.nama.length >= 2) {
            let prefix = this.nama.substring(0, 2).toUpperCase();
            this.code = prefix + '-' + this.stock;
        } else {
            this.code = '';
        }
    },
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <input type="text" :readonly="true" name="code" id="code" x-model="code" tabindex="-1"
                            class="block w-full border-gray-200 rounded-lg text-sm px-4 py-2.5 bg-gray-50 border @error('code') border-red-500 @enderror cursor-not-allowed pointer-events-none focus:outline-none"
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <select id="kategori_id" name="kategori_id" class="block w-full border-gray-200 rounded-lg text-sm focus:ring-indigo-500 focus:border-indigo-500 px-4 py-2.5 bg-gray-50 border @error('kategori_id') border-red-500 @enderror">
